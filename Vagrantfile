...
Vagrant.configure("2") do |config|
  ...
  config.vm.hostname = "voland-starter"
  ...
  #   chef.chef_server_url = "https://chef.elt/organizations/elt"
  #   chef.validation_client_name = "elt-validator"
  #   chef.validation_key_path = ".chef/elt-validator.pem"
  # end
end
